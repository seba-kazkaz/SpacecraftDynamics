...
fig2 = figure(2);
subplot(3,1,1)
plot(time, btrue(:,1), 'Color', bittersweet, 'LineWidth', 2); %  true bias vector 1st component
...
subplot(3,1,2)
plot(time, btrue(:,2), 'Color', bittersweet, 'LineWidth', 2); %  true bias vector 1st component
xticks([]); xlim([0 5668]); ylim([-25000 15000]); ylabel('$b_y$ / nT')
ax = gca; ax.Color = jet; ax.YColor = 'w'; ax.XColor = 'w'; hold on;
plot(time, x(:,2), 'Color', celadon, 'LineWidth', 2);
subplot(3,1,3)
plot(time, btrue(:,3), 'Color', bittersweet, 'LineWidth', 2); %  true bias vector 1st component
xlim([0 5668]); ylim([-5000 30000]); ylabel('$b_z$ / nT')
ax = gca; ax.Color = jet; ax.YColor = 'w'; ax.XColor = 'w'; hold on;
...
fig3 = figure(3);
subplot(3,1,1)
plot(time, abs(x(:,1)-btrue(:,1)), 'Color', paynes_gray, 'LineWidth', 2);
xticks([]); xlim([0 5668]); ylim([0 32000]); ylabel('$b_x$ / nT')
ax = gca; ax.Color = jet; ax.YColor = 'w'; ax.XColor = 'w'; hold on;
subplot(3,1,2)
plot(time, abs(x(:,2)-btrue(:,2)), 'Color', paynes_gray, 'LineWidth', 2)
xticks([]); xlim([0 5668]); ylim([0 32000]); ylabel('$b_y$ / nT')
ax = gca; ax.Color = jet; ax.YColor = 'w'; ax.XColor = 'w'; hold on;
subplot(3,1,3)
plot(time, abs(x(:,3)-btrue(:,3)), 'Color', paynes_gray, 'LineWidth', 2)
